...
//por que esto no es un bien por que no es instanciable por que es de herencia. 
@NoRepositoryBean
public interface PersonaRepository extends CrudRepository<Persona, Integer>
{
	...
	//Spring data 	
	//public Optional<Persona> findPersonaByNombreApellido(String nombre, String apellido);
