...
//@Table(name="personas")
//para cuando hay herencia, existen 3 estrategias single_table(todos los atributos deben de ser nulos)
//.Joined(va a jalar los atributos de la herencia, no duplica informacion)
//table_per_class (prohibido)
@Inheritance(strategy = InheritanceType.JOINED)
//abstract no se puede instanciar la clase 
